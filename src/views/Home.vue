<template>
    <div>
        ...
        <div class="position-relative">
            <!-- shape Hero -->
            <section class="section-shaped-1 my-0">
                <div>
                    <h2>Energia fogyasztás okosan</h2>
                    <p>Vállalkozásunk innovatív megoldásokat nyújtva szeretné kielégíteni elsősorban a lakossági felhasználók igényeit az alábbi kategóriákban:</p>
                </div>
            </section>
            <!-- 1st Hero Variation -->
        </div>
